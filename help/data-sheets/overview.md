...
Esta documentação descreve as melhorias no ciclo de vida do caso de suporte Adobe DX com a intenção de aumentar a comunicação e fornecer resoluções para os clientes o mais rápido possível para ajudar a garantir o sucesso do cliente. Abaixo estão as linhas do tempo e notificações para vários cenários encontrados durante o processo de suporte:
...
|--- |--- |--- |--- |
| **1º** | Resposta Ou Resolução Pendente Fornecida | 24 horas / 1 dia | 5 dias |
| **2nd** | Resposta Pendente Ou Resolução Fornecida | 72 horas/3 dias | 3 dias |
| **3º** | Resposta Ou Resolução Pendente Fornecida | 120 horas/5 dias | 1 dia |
| **4th** | Resposta ou Resolução Pendente Fornecida alterada para &quot;Fechada Automaticamente&quot; | 144 horas/6 dias | fechado |

**Cenários detalhados**

**Informações adicionais são necessárias de um cliente**
