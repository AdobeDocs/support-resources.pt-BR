...
Depois de selecionar **[!UICONTROL Abrir um tíquete de suporte]** ou **[!UICONTROL Abrir tíquete]**, a página de criação do caso é exibida.

O formulário usa um fluxo de trabalho guiado de várias etapas:

* Selecione o produto Adobe afetado
* Descreva o problema
* Fornecer detalhes do sistema e do ambiente
* Indique o impacto e a urgência
* Confirmar informações de contato
* Revisar e enviar os detalhes
...
1. Clique no nome do produto para selecionar o produto afetado e clique em **[!UICONTROL Avançar]**.
   ...
   ![Selecione um produto na Experience League](./assets/select-product.png)

1. Na seção **[!UICONTROL Detalhes do problema]**, insira o título da ocorrência, descreva o problema e forneça etapas para reproduzir.

   ![Detalhes de problemas da Experience League](./assets/issue-details.png)

   Incluir detalhes como:

   * O que você está tentando fazer
   * O que não está funcionando como esperado
   * Qualquer alteração recente no ambiente
   * Etapas que você já realizou

   À medida que você insere os detalhes do problema, o Experience League exibe as recomendações habilitadas por IA em um painel ao lado do formulário. Estas recomendações:
...
1. Na seção **[!UICONTROL Informações do Sistema]**, selecione o ambiente e clique em **[!UICONTROL Avançar]**.
...
1. Na seção **[!UICONTROL Impacto]**, selecione o seguinte:
   * Prioridade de caso (P4 - Menor, P3 - Importante, P2 - Urgente, P1 - Crítico)
   * Impacto nos negócios (pequeno, Medium, grande)

   ![Detalhes de impacto da Experience League](./assets/impact.png)
...
1. Na seção **[!UICONTROL Informações de Contato]**, selecione o fuso horário, insira seu número de telefone, adicione observadores, anexe quaisquer arquivos, se necessário, e clique em **[!UICONTROL Avançar]**.

   ![Informações de contato da Experience League](./assets/contact-information.png)

1. Na seção **[!UICONTROL Revisar e enviar]**, reveja os detalhes do seu caso e clique em **[!UICONTROL Enviar]**.

   ![Revisão e envio da Experience League](./assets/review-and-submit.png)
