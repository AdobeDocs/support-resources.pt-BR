...
A página **[!UICONTROL Home]** serve como hub central para as atividades de suporte. Ele fornece uma visão geral do ambiente de suporte e acesso rápido aos principais recursos.

![Página inicial da nova interface do EXL](/help/adobe-support-tools-guide/assets/home-page-new-ui-2.png)
...
- **[!UICONTROL Abrir Caso]** abre o fluxo de trabalho de criação de caso no portal reprojetado.
- **[!UICONTROL Meus Casos]** abre a lista de casos no portal reprojetado.
...
O portal pré-seleciona a guia que corresponde à seleção original:

- Se você selecionar **[!UICONTROL Meus Casos]** no **[!UICONTROL Service Analytics]**, a guia **[!UICONTROL Meus Casos]** será pré-selecionada.
- Se você selecionar **[!UICONTROL Meus Casos de Organização]** no **[!UICONTROL Service Analytics]**, a guia **[!UICONTROL Meus Casos de Organização]** será pré-selecionada.
...
![Seção Alertas de Status do Sistema](/help/adobe-support-tools-guide/assets/system-alerts-updated.png)

### Gerenciar assinaturas

Use o **[!UICONTROL Gerenciar assinaturas]** para configurar notificações por email para eventos de status de produtos e serviços da Adobe. Quando houver uma atualização de um produto no qual você se inscreveu, você receberá um alerta.
...
2. Na página **[!UICONTROL Gerenciar assinaturas]**, selecione **[!UICONTROL Criar assinatura]**.

   ![Criar assinatura](assets/create-subscriptions.png)

3. Em **[!UICONTROL Selecione a Nuvem]**, selecione a nuvem do Adobe que contém o produto que você deseja monitorar.
4. Em **[!UICONTROL Selecionar Produtos e Ofertas]**, selecione o produto para o qual deseja receber notificações.
...
7. Revise as configurações de notificação padrão, incluindo o idioma e o fuso horário.
8. Selecione **[!UICONTROL Continuar]**.
9. Revise os detalhes da assinatura, incluindo a nuvem, o produto, os serviços, as regiões e os tipos de evento selecionados.
10. Selecione **[!UICONTROL Confirmar]** para criar a assinatura.

    ![Confirmar detalhes da assinatura](assets/confirm-subscription.png)

11. Uma mensagem de confirmação é exibida e a subscrição é criada.
...
Esta seção exibe os principais detalhes sobre o plano de suporte (Ultimate Success plan e Expert Success plan) e os benefícios disponíveis. Selecione **[!UICONTROL Saiba mais]** para explorar a gama completa de ofertas de planos.

## Meu sucesso

A página **[!UICONTROL Meu Sucesso]** fornece uma exibição personalizada do engajamento com a Adobe. Ele oferece acesso direto à equipe de sucesso, aos benefícios do programa e aos recursos de aprendizado.

>[!NOTE]
>  
>Esta página está disponível somente para clientes do plano **[!UICONTROL Ultimate Success]**.

![Minha página de sucesso](/help/adobe-support-tools-guide/assets/my-success-page-1.png)
...
Esta seção exibe sua equipe dedicada de Sucesso do Adobe. Selecione **[!UICONTROL Contato]** ao lado de um membro da equipe para enviar um email.

![seção Equipe de Sucesso do Adobe](/help/adobe-support-tools-guide/assets/adobe-success-team-1.png)