...
- As [políticas](https://helpx.adobe.com/br/enterprise/global-admin-console/update-policies.html) da organização de organizações movidas são atualizadas para que qualquer bloqueio nas políticas seja mantido por uma organização na nova hierarquia.
