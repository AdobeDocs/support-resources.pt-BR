---
title: Forçar a expiração da senha no Admin Console
description: Saiba como os administradores de sistema da organização podem definir um limite de tempo de expiração de senha para seus usuários na Adobe Admin Console.
