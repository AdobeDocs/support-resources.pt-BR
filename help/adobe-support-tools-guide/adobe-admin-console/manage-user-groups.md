...
5. Selecione **[!UICONTROL Revisar alterações pendentes]** para revisar as atualizações. Em seguida, selecione **[!UICONTROL Enviar alterações]** para [executá-las](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs).
...
8. Selecione **[!UICONTROL Revisar alterações pendentes]** para revisar as atualizações. Em seguida, selecione **[!UICONTROL Enviar alterações]** para [executá-las](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs).
...
7. Selecione **[!UICONTROL Revisar alterações pendentes]** para revisar as atualizações. Em seguida, selecione **[!UICONTROL Enviar alterações]** para [executá-las](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs).
...
4. Selecione **[!UICONTROL Revisar alterações pendentes]** para revisar as atualizações. Em seguida, selecione **[!UICONTROL Enviar alterações]** para [executá-las](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs).
...
4. Depois de editar as organizações, selecione **[!UICONTROL Revisar alterações pendentes]** para analisá-las. Em seguida, selecione **[!UICONTROL Enviar alterações]** para [executá-las](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs).
