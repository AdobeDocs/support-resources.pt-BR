...
Acesse a guia **[!UICONTROL Organizações]** no [Global Admin Console](https://helpx.adobe.com/enterprise/global-admin-console/adopt-global-administration.html) para exportar ou importar a estrutura da organização. Acesse a guia **[!UICONTROL Alocação de Produto]** para exibir os dados de alocação. Selecione o ícone **[!UICONTROL Mais Opções]** () e escolha **[!UICONTROL Exportar]** ou **[!UICONTROL Importar]**.
Acesse aqui para [entrar na Global Admin Console](https://global-admin-console.adobe.com).
...
O campo de recursos só está presente para o formato JSON. Para os formatos CSV e XLSX, os recursos são representados com os seguintes campos adicionais: resourceName, resourceId, resourceDescription, icon, seleted, quota, resourceType. Para obter detalhes sobre esses campos, consulte a seção Produtos e recursos.
