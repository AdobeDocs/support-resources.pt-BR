...
Para que os clientes do Commerce Intelligence Essentials cancelem suas assinaturas ou atualizem seus métodos de pagamento, eles devem ser os principais titulares da conta da Magento. As etapas são:

1. Navegue até [account.magento.com](https://account.magento.com) e faça logon.
2. Clique em **[!UICONTROL Magento]** > **[!UICONTROL Meus Produtos e Serviços]** > **[!UICONTROL Magento Business Intelligence]** e clique em **[!UICONTROL Mostrar Detalhes]** ao lado da licença que você deseja atualizar.
3. Selecione **[!UICONTROL Atualizar método de pagamento]** ou **[!UICONTROL Cancelar licença]**.
