...
1. Uma nova opção **[!UICONTROL Todos os Horários]** foi introduzida na lista suspensa de filtros **[!UICONTROL Intervalo de Tempo]**, na página **[!UICONTROL Meus Casos]**, permitindo que o histórico completo do caso seja exibido além dos últimos 24 meses.

1. O widget **[!UICONTROL Insights do Sistema]** do Adobe Commerce no formulário de criação de caso foi reposicionado para aparecer acima da seção **[!UICONTROL Recomendações da IA]** na barra lateral direita.
